...
describe('(arrayChunks) divide array in [num] numbers of sub-arrays, lengths differ as less as possible', () => {
    ...
    test('2 balanced sub-arrays', () => {
        expect(arrayChunks(input, 2)).toEqual([
    ...
    test('3 sub-arrays from a 9 lenght array, perfect division and perfect balance', () => {
        expect(arrayChunks(input, 3)).toEqual([
            ['lorem', 'ipsum', 'dolor'],
    ...
    test('4 balanced sub-arrays', () => {
        expect(arrayChunks(input, 4)).toEqual([
            ['lorem', 'ipsum', 'dolor'],
            ['sit', 'consectetur'],
            ['adipiscing', 'elit'],
            ['sed do', 'eiusmod']
    ...
    test('5 balanced sub-arrays', () => {
        expect(arrayChunks(input, 5)).toEqual([
            ['lorem', 'ipsum'],
            ['dolor', 'sit'],
    ...
    test('7 balanced sub-arrays', () => {
        expect(arrayChunks(input, 7)).toEqual([
            ['lorem', 'ipsum'],
            ['dolor', 'sit'],
            ['consectetur'],
            ['adipiscing'],
