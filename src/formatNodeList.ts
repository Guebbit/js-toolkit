...
export default (
    ...
    if (elementsArray instanceof NodeList) elementsArray = Array.prototype.slice.call(elementsArray)
    if (!Array.isArray(elementsArray)) elementsArray = [elementsArray as HTMLElement]
